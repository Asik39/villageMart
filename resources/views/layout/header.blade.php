    ...
    <section class="header sticky-top">
        ...
        <ul>
            ...
            <li><a href="{{url('./trackOrder')}}"><i class="fa-solid fa-truck icon"></i> Track Your Order</a></li>
            <li><a href=""><i class="fa-solid fa-cart-shopping icon"></i> Shop</a></li>
            <li><a href="{{url('./myAccount')}}"><i class="fa-regular fa-user icon"></i> My Account</a></li>
        </ul>
    </section>
